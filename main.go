...
type Posts struct {
	...
	Title    string `form:"title" json:"title" validate:"required,min=20"`
	Content  string `form:"content" json:"content" validate:"required,min=200"`
	Category string `form:"category" json:"category" validate:"required,min=3"`
